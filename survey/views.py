...
QUESTIONS = {
    ...
    2: {  
        ...
        'type': 'text', 
        'img': 'https://i.imgur.com/enLyB7z.jpeg',
        'placeholder': 'MBTI',
        'button_text': '> 다음 문제',
    },
    3: {  
        ...
        'type': 'text', 
        'img': 'https://i.imgur.com/x2frzKD.jpeg',
    ...
    4: {
        ...
        'img': 'https://i.imgur.com/jCcLrxE.jpeg',
        'button_text': '> 다음 문제',
    },
    5: { 
        'title': 'Q5',
        'sub_title': '[취미 트렌드 조사]\n어떤 취미가 있으신가요?',
        'type': 'text', 
        'img': 'https://i.imgur.com/JViBj6Y.jpeg',
        'placeholder': '텍스트를 입력해 주세요.',
        'button_text': '> 다음 문제',
    },
    6: {
        ...
        'img': 'https://i.imgur.com/B8rqei5.jpeg',
        'button_text': '> 다음 문제',
    },
    7: {  
        'title': 'Q7',
    ...
    8: {  
        ...
        'sub_title': '[취미 트렌드 조사]\n하루의 언제 주로 취미를 즐기시나요?',
        'type': 'text', 
        'img': 'https://i.imgur.com/dHICZCX.jpeg',
        'placeholder': '텍스트를 입력해 주세요.',
        'button_text': '> 다음 문제',
    },
    9: {
        ...
        'img': 'https://i.imgur.com/3UkcpDh.jpeg',
        'button_text': '> 다음 문제',
    },
    10: {
        'title': 'Q10',
        ...
        'img': 'https://i.imgur.com/GHFHJ03.jpeg',
        'button_text': '> 다음 문제',
    },
    11: {
        'title': 'Q11',
        ...
        'img': 'https://i.imgur.com/PHJxzec.jpeg',
        'button_text': '> 다음 문제',
    },
    12: {  
        'title': 'Q12',
        'sub_title': '[여행 트렌드 조사]\n구체적인 계획이 있다면 알려주세요!',
        'type': 'text', 
        'img': 'https://i.imgur.com/Je7XRHy.jpeg',
        'placeholder': '텍스트를 입력해 주세요.',
        'button_text': '> 다음 문제',
    },
    13: {
        ...
        'img': 'https://i.imgur.com/0fYSUmd.jpeg',
        'button_text': '> 다음 문제',
    },
    14: {
        'title': 'Q14',
        ...
        'img': 'https://i.imgur.com/JWuloxb.jpeg',
        'button_text': '> 다음 문제',
    },
    15: {
        'title': 'Q15',
    ...
    16: {  
        ...
        'type': 'text', 
        'img': 'https://i.imgur.com/b1iyYam.png',
        'placeholder': '텍스트를 입력해 주세요.',
        'button_text': '> 다음 문제',
    },
    17: {  
        ...
        'sub_title': '[20대 생각 트렌드 조사]\n요즘 가장 오래 붙잡고 있는 고민은?\n그 고민이 시작된 계기는 무엇인가요?',
        'type': 'text', 
        'img': 'https://i.imgur.com/JzFEjRr.png',
        'placeholder': '텍스트를 입력해 주세요.',
        'button_text': '> 다음 문제',
    },
    18: {
        ...
        'type': 'score', 
        'img': 'https://i.imgur.com/oFKU5Ef.jpeg',
        'button_text': '다음 문제',
    },
    19: {
        'title': '인터뷰어',
